...
class FuzzyPlayer(Player):
    def __init__(self, racket: Racket, ball: Ball, board: Board):
        ...
        self.y_mf = {
            "near": fuzz.trimf(self.y_universe, [40,40,400]),
            "so_close" : fuzz.trimf(self.y_universe, [0,0,90])
        }
        self.velocity_fx = {
            ...
            "shift" : lambda x_diff, y_diff: 1 *x_diff 
        }
    ...
    def make_decision(self, x_diff: int, y_diff: int):
        ...
        activations = {
            ...
            "stop" : min(x_vals["center"], y_vals['near']),
            "shift" : min(x_vals["center"], y_vals['so_close'])
        }
        velocity = sum(
